...
public class Transaction {
	...
	public ArrayList<TransactionInput> inputs = new ArrayList<TransactionInput>(); // 거래를 위한 UTXO
	public ArrayList<TransactionOutput> outputs = new ArrayList<TransactionOutput>(); // 거래 후 생성할 UTXO
